...
Preferences:
{:git=>true, :railsapps=>"rails3-bootstrap-mongoid-devise", :database=>"mongodb", :orm=>"mongoid", :unit_test=>"rspec", :integration=>"cucumber", :fixtures=>"factory_girl", :frontend=>"bootstrap", :email=>"gmail", :authentication=>"devise", :devise_modules=>"default", :authorization=>"none", :starter_app=>"users_app", :form_builder=>"none", :dev_webserver=>"webrick", :templates=>"erb", :bootstrap=>"sass", :ban_spiders=>true, :jsruntime=>false}
